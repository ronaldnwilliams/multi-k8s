...
kubectl set image deployments/client-deployment server=ronaldnwilliams/muti-client:$SHA
kubectl set image deployments/worker-deployment server=ronaldnwilliams/muti-worker:$SHA
